    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-warning">
          ...
          <div class="box-body">
            <form method="POST" id="stateForm" action="{{route('cities.store')}}" accept-charset="UTF-8">
              @csrf
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group" >
                      ...
                      {{trans('states.state_name')}}
                      </label>
                      {!! Form::select('state_name', [], null, ['class' => 'form-control','placeholder' => trans('services.select'), 'id' => 'state_name']) !!}
                      @error('state_name')
                        <div class="help-block">{{ $message }}</div>
                      @enderror
                    </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="{{trans('cities.enter_city')}}" required="true" name="city_name" type="text" id="name"  value="{{old('name')}}" required>
                      @error('city_name')
                        <div class="help-block">{{ $message }}</div>
                      @enderror
                    </div>
