      ...
      <div class="col-xs-12">
        <div class="box box-info">
          <div class="box-header">
            ...
            <h3 class="box-title pull-right"><a href="{{route('states.create')}}" class="btn btn-success pull-right">{{trans('states.add_new')}}</a></h3>
          </div>
          <div class="box-body">
...
<script type="text/javascript">
  $(document).on('change','.state_status',function(){
      ...
      $.ajax({
          ...
          beforeSend: function () {
            if(status == 'inactive'){
              return confirm("{{trans('states.are_u_sure_to_inactive_status')}}");
            }
    ...
    function fill_datatable() {
      ...
      $('#states').DataTable({
        ...
        columns: [
           ...
           { 
              mRender : function(data, type, row) {
                   return '<a class="btn" href="'+row["edit"]+'"><i class="fa fa-edit"></i></a><a class="btn" href="'+row["show"]+'"><i class="fa fa-eye"></i></a>@csrf</form>';  
